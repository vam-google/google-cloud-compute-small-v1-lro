...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (addressType_ != com.google.cloud.compute.v1.Address.AddressType.UNDEFINED_ADDRESS_TYPE.getNumber()) {
      output.writeEnum(264307877, addressType_);
    }
    if (ipVersion_ != com.google.cloud.compute.v1.Address.IpVersion.UNDEFINED_IP_VERSION.getNumber()) {
    ...
    if (networkTier_ != com.google.cloud.compute.v1.Address.NetworkTier.UNDEFINED_NETWORK_TIER.getNumber()) {
