...
import static com.google.cloud.compute.v1.stub.HttpJsonAddressesStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonAddressesStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonAddressesStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonAddressesStub.listMethodDescriptor;
...
public class AddressesClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, AddressesStubSettings.getDefaultEndpoint());

  private static AddressesClient client;
  private static AddressesSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        AddressesSettings.newBuilder()
            ...
            .build();
    client = AddressesClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    List<Entry<String, AddressesScopedList>> resources =
